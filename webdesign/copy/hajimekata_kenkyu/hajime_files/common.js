    ...
    t.fn.bxSlider = function (n) {
        ...
        var a = t(window).width(),
            ...
            d = function () {
                ...
                r
                    .children(o.settings.slideSelector)
                    .each(function () {
            ...
            c = function () {
                ...
                o
                    .children
                    .css("width", u()),
                "horizontal" == o.settings.mode && o.settings.slideMargin > 0 && o
                    .children
                    .css("marginRight", o.settings.slideMargin),
                "vertical" == o.settings.mode && o.settings.slideMargin > 0 && o
                    .children
                    .css("marginBottom", o.settings.slideMargin),
                "fade" == o.settings.mode && (o.children.css({display: "none", position: "absolute", zIndex: 0}), o.children.eq(o.settings.startSlide).css({display: "block", zIndex: o.settings.slideZIndex})),
            ...
            p = function () {
                var t = "100%";
                return o.settings.slideWidth > 0 && (t = "horizontal" == o.settings.mode
            ...
            S = function () {
                if (o.children.length > o.settings.maxSlides && o.active.last && !o.settings.infiniteLoop) {
                    ...
                    void 0 != e && ("horizontal" == o.settings.mode
                        ? b(-e.left, "reset", 0)
            ...
            w = function () {
                for (var e = "", i = x(), s = 0; i > s; s++) {
                    ...
                    e += '<div class="bx-pager-item"><a href="" data-slide-index="' + s + '" class="bx-p' +
                            'ager-link">' + n + "</a></div>"
                }
                o
                    .pagerEl
            ...
            E = function () {
                o.controls.start  = t('<div class="bx-controls-auto-item"><a class="bx-start" href="">' +
                        o.settings.startText + "</a></div>"),
                o.controls.stop   = t('<div class="bx-controls-auto-item"><a class="bx-stop" href="">' +
                        o.settings.stopText + "</a></div>"),
                ...
                o
                    ...
                    .each(function () {
                        var e = t(this)
                            .find("img:first")
                            .attr("title");
                        void 0 != e && ("" + e).length && t(this).append('<div class="bx-caption"><span>' +
                                e + "</span></div>")
                    })
            },
            y = function (t) {
            ...
            q = function (e) {
                ...
                return "short" == o.settings.pagerType
                    ? (o.settings.maxSlides > 1 && (i = Math.ceil(o.children.length / o.settings.maxSlides)), o.pagerEl.html(e +
                            1 + o.settings.pagerShortSeparator + i), void 0)
            ...
            D = function () {
                ...
                o
                    .settings
                    .onSlideAfter(o.children.eq(o.active.index), o.oldIndex, o.active.index)
            },
            A = function (t) {
                o.settings.autoControlsCombine
                    ? o
                        ...
                        .autoEl
                        .html(o.controls[t])
                    : (o.controls.autoEl.find("a").removeClass("active"), o.controls.autoEl.find("a:not(.bx-" +
                            t + ")").addClass("active"))
            },
            W = function () {
                1 == x()
            ...
            L = function () {
                ...
                o.settings.tickerHover && !o.usingCSS && o
                    .viewport
                    .hover(function () {
                        r.stop()
                    }, function () {
            ...
            Y = function (t) {
                ...
                if (3 * i > s && o.settings.preventDefaultSwipeX
                    ? t.preventDefault()
            ...
            V = function (t) {
                ...
                if (o.touch.end.x = e.changedTouches[0].pageX, o.touch.end.y = e.changedTouches[0].pageY, "fade" == o.settings.mode) {
                    ...
                    s >= o.settings.swipeThreshold && (o.touch.start.x > o.touch.end.x
                        ? r.goToNextSlide()
                        : r.goToPrevSlide(),
                    r.stopAuto())
                } else {
        ...
        return r.goToSlide       = function (e, i) {
            if (!o.working && o.active.index != e)
                if (o.working = !0, o.oldIndex = o.active.index, o.active.index = 0 > e
                    ? x() - 1
                    : e >= x()
                        ? 0
                        : e,
...
!function (a) {
    ...
    a.event.special.inview = {
        add   : function (c) {
            b.push({$element: a(this), data: c, element: this}),
...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        if (wSize > 1080) {
            $('#cover, #cover .bx-wrapper, #cover .bxslider, #cover .bx-viewport, #cover .bxs' +
                    'lider li, #cover .filter').height(hSize);
            $('.home #wrap').css("paddingTop", hSize);
        } else {
            $('#cover, #cover .bx-wrapper, #cover .bxslider, #cover .bx-viewport, #cover .bxs' +
                    'lider li, #cover .filter').height(hSize);
        }
    ...
    $(window).on('scroll', function () {
        if ($(this).scrollTop() > hSize) {
            $('.mini_header').addClass('fixed');
            $('#logo_sp').addClass('color');
            $('#sp_menu').addClass('color');
        } else {

            $('.mini_header').removeClass('fixed');
            $('#logo_sp').removeClass('color');
            $('#sp_menu').removeClass('color');
        }
        if ($(this).scrollTop() > hSize - 20) {
    ...
    //bxSlider
    var $slider1 = $('.l_slideshow');
    var $slider2 = $('.r_slideshow');
    var activeClass1 = 'active-slide1';
    var activeClass2 = 'active-slide2';
    $('.l_slideshow').bxSlider({
        auto                : true,
        controls            : false,
        mode                : 'fade',
        onSlideAfter        : function ($slideElement, oldIndex, newIndex) {
            $slider1
                .children('li')
                .removeClass(activeClass1)
                .eq(newIndex)
                .addClass(activeClass1);
        },
        onSliderLoad        : function () {
            $slider1
                .children('li')
    ...
    $('#sp_menu').click(function () {
        $('#sp_menu, #sp_nav, #logo_sp, #header.top, .logo').toggleClass('active');
    });

    $('#about_link, #about_close').click(function () {
        $('#about_link, #about_page, #header').toggleClass('active_a');
    });

    $('#cover_logo, .box_list article, #about p, #buyer_list_box, #buyer_list_box li,' +
            ' #buyer_info, .buyer_bottom, .reco, .s_cover, .l_slideshow, .r_slideshow, .cen' +
            'ter').on('inview', function (event, isInView, visiblePartX, visiblePartY) {
        if (isInView) {
            $(this)
                .stop()
                .addClass('active');
...
!function (a) {
    ...
    a
        ...
        .extend({
            ...
            smoothScroll   : function (b, c) {
                ...
                return null !== b.delegateSelector
                    ? this
                        .off("click.smoothscroll", b.delegateSelector)
                        .on("click.smoothscroll", b.delegateSelector, e)
                    : this
    ...
    a.smoothScroll             = function (b, d) {
        ...
        "number" == typeof b
            ? (e = a.extend({
                link: null
            }, a.fn.smoothScroll.defaults, c), g = b)
            : (e = a.extend({
                link: null
            }, a.fn.smoothScroll.defaults, b || {}, c), e.scrollElement && (k = "position", "static" === e.scrollElement.css("position") && e.scrollElement.css("position", "relative"))),
        l       = "left" === e.direction
            ? "scrollLeft"
            : l,
        e.scrollElement
            ? (f = e.scrollElement, /^(?:HTML|BODY)$/.test(f[0].nodeName) || (j = f[l]()))
        ...
        g    = "number" == typeof b
            ? b
            : d || a(e.scrollTarget)[k]() && a(e.scrollTarget)[k]()[e.direction] || 0,
        m[l] = g + j + e.offset,
        h    = e.speed,
...
$(document).ready(function () {
    $('.scroll, #pagetop a').smoothScroll();
});

/* ! Smooth Scroll - v1.4.12 - 2013-09-19
 * https://github.com/kswedberg/jquery-smooth-scroll Copyright (c) 2013 Karl
 * Swedberg Licensed MIT
 * (https://github.com/kswedberg/jquery-smooth-scroll/blob/master/LICENSE-MIT)
 */
